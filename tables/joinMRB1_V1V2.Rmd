...
```{r compV1_V2, include=FALSE, echo=FALSE, cache=FALSE}
...
```{r Rows1,2, include=TRUE, echo=FALSE, cache=FALSE}
...
```{r Rows3,4, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-1  #flag for row.  
...
```{r Rows5,6, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-1  #flag for row.  
...
```{r Rows7,8, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-1  #flag for row.  
...
```{r Rows9,10, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-1  #flag for row.  
...
```{r Rows11:13, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-1  #flag for row.  
...
```{r Rows14,15, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-1  #flag for row.  
...
```{r Rows16:18, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-1  #flag for row.  
...
```{r Rows19:20, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
...
```{r Rows21:22, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-2  #flag for row.  
...
```{r Rows23, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
...
```{r Rows23a, include=TRUE, echo=FALSE, cache=FALSE}
    par(mfrow=c(1,2))
...
```{r Rows24, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-3  #flag for row.  
...
```{r Rows24a, include=TRUE, echo=FALSE, cache=FALSE}
    par(mfrow=c(1,2))
...
```{r Rows25, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-3  #flag for row.  
...
```{r Rows25a, include=TRUE, echo=FALSE, cache=FALSE}
    par(mfrow=c(1,2))
...
```{r Rows26, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-3  #flag for row.  
...
```{r Rows26a, include=TRUE, echo=FALSE, cache=FALSE}
    par(mfrow=c(1,2))
...
```{r Rows27, include=TRUE, echo=FALSE, cache=FALSE}
    showMaps(Rows,Zoom)  #make the plots
  #add Rows to joinMRB1_V1V2
      a<-chkV1V2[Rows,c('WBID_V1','WBID_V2')]
        a$flag<-3  #flag for row.  
...
```{r Rows27a, include=TRUE, echo=FALSE, cache=FALSE}
    par(mfrow=c(1,2))
...
```{r missingLakes, include=TRUE, echo=FALSE, cache=FALSE}
...
```{r h1, include=TRUE, echo=FALSE, cache=FALSE}
...
```{r Save, include=FALSE, echo=FALSE, cache=FALSE}
  #save the data
    save(joinMRB1_V1V2,file='../tables/joinMRB1_V1V2.rda')
```
